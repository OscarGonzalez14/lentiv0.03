<table width="100%" class="table2" style="margin: 1px">
 ...
 <tr style="margin-top: 5px">
 	<td class="td-data-opt" colspan="50" style="width: 50%"><span class="data-opt"><b>&nbsp;NIT: </b> <?php echo $nit;?></span></td>
 	<td colspan="50" style="width: 50%"><span class="data-opt"><b>&nbsp;NRC: </b> <?php echo $nrc;?></span></td>
 </tr>
 <tr>
 	<td class="td-data-opt" colspan="100" style="width: 100%"><span class="data-opt"><b>&nbsp;Giro: </b> <?php echo $giro;?></span></td>
 </tr>
 <tr>
...
<table class="table2 info-productos data-montos" width="100%">
	<tr>
		<td colspan="60" style="width: 60%"><b>SON</b>: <?php echo numletras(number_format($subtotal,2,".",","),$_moneda);?></td>
