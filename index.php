...
<div class="login-box">
  ...
  <div class="card log log-div">
    <div class="card-body login-card-body" style="border-radius: 8px !important">
      <div style="border-bottom: 5px !important">
        <img src="dist/img/lenti_logo.png" alt="" class="img-responsive log" width="180" height="155" align="center">
      </div>
      <form method="post" style=" margin-top:10px">
        
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Usuario" style="border: 1px solid green" name="usuario">
          <div class="input-group-append">
            <div class="input-group-text" style="border: 1px solid green">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Password" style="border: 1px solid red" name="pass">
          <div class="input-group-append">
