...
class Cobros extends conectar{
    ...
    public function getCreditosRango($argumentos){
       ...
       /* $fechas = explode("/", $fecha);
        ...
        $sql = "SELECT c.id_credito,cf.n_correlativo,c.monto,o.paciente,o.codigo,op.nombre,s.direccion,c.estado,c.fecha_pago,c.saldo FROM creditos as c INNER join creditos_fiscales as cf on c.codigo_orden=cf.codigo_orden inner join orden as o on cf.codigo_orden=o.codigo inner join optica as op on op.id_optica=c.id_optica INNER JOIN sucursal_optica as s on c.id_sucursal=s.id_sucursal where c.fecha_fact BETWEEN ? AND ?;";
